...
class FreeplayState extends MusicBeatState
{
	...
	var checker:FlxBackdrop = new FlxBackdrop(Paths.image('checkerArrow'), 0.2, 0.2, true, true);
	public var checkerAngle:Float;
	public var checkerAngleSpeed = 0.01;
	...
	override function update(elapsed:Float)
	{
		...
		checker.x -= 0.27 / (elapsed) / 100;
		checker.y -= -0.2 / (elapsed) / 100;

		checkerAngle += checkerAngleSpeed * 2;
		checker.angle = checkerAngle;
