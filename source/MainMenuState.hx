...
class MainMenuState extends MusicBeatState
{
	...
	public static var afnfvsmVersion:String = "0.1.1";
	...
	override function create()
	{
		...
		var bg2:FlxSprite = new FlxSprite(-80).loadGraphic(Paths.image('menuGrad'));
		...
		var versionShit1:FlxText = new FlxText(12, FlxG.height - 64, 0, "AFNFVSM Engine v" + afnfvsmVersion, 12);
		...
		add(versionShit1);
		var versionShitBoulder:FlxText = new FlxText(12, FlxG.height - 44, 0, "Psych Engine v" + psychEngineVersion, 12);
		versionShitBoulder.scrollFactor.set();
		versionShitBoulder.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShitBoulder);
