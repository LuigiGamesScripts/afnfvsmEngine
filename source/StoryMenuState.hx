...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in 0...WeekData.weeksList.length)
		{
			...
			var weekThing:MenuItem = new MenuItem(150, bgSprite.y + 396, WeekData.weeksList[i]);
		...
		var tracksSprite:FlxSprite = new FlxSprite(950, bgSprite.y + 425).loadGraphic(Paths.image('Menu_Tracks'));
		tracksSprite.antialiasing = ClientPrefs.globalAntialiasing;

		txtTracklist = new FlxText(950, tracksSprite.y + 60, 0, "", 32);
